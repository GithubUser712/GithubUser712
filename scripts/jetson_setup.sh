...
echo ""
echo "Or run steps 0-4 in one go:"
echo "  bash scripts/run_pipeline.sh bullet_learn sample"
echo "  bash scripts/run_pipeline.sh quick_train sample"
echo "  bash scripts/run_pipeline.sh deep_learn sample"
